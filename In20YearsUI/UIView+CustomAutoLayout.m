...
- (UIView *)scaleToLeftOf:(UIView *)brotherView margin:(CGFloat)margin
{
    ...
    CGRect rect = self.frame;
    CGRect brect = brotherView.frame;
    rect.size.width = rect.origin.x + rect.size.width - (brect.origin.x + margin);
...
- (UIView *)alignTop:(UIView *)brotherView
{
    IsArgInvalid(self, brotherView);
    CGRect rect = self.frame;
    rect.origin.y = brotherView.frame.origin.y;
    self.frame = rect;
    return self;
}
- (UIView *)alignBottom:(UIView *)brotherView
{
    ...
    CGRect rect = self.frame;
    CGRect brect = brotherView.frame;
    rect.origin.y = brect.origin.y + brect.size.height - rect.size.height;
    self.frame = rect;
    return self;
}
- (UIView *)alignLeft:(UIView *)brotherView
{
    IsArgInvalid(self, brotherView);
    CGRect rect = self.frame;
    rect.origin.x = brotherView.frame.origin.x;
    self.frame = rect;
    return self;
}
- (UIView *)alignRight:(UIView *)brotherView
{
    ...
    CGRect rect = self.frame;
    CGRect brect = brotherView.frame;
    rect.origin.x = brect.origin.x + brect.size.width - rect.size.width;
    self.frame = rect;
    return self;
}
...
//- (UIView *)gridViews:(NSArray *)views inColumn:(NSInteger)column size:(CGSize)cellSize inRect:(CGRect)rect
//{
//    CGSize menuSize = cellSize;
//    CGRect gridRect = rect;
//    
//    const NSInteger kColumn = column;
//    const NSInteger kCount = array.count;
//    const NSInteger kRow = kCount % kColumn == 0 ? kCount / kColumn : kCount / kColumn + 1;
//    
//    const CGSize kSpaceSize = CGSizeMake(10, 10);
//    CGSize showSize = CGSizeZero;
//    if (kRow == 1)
//    {
//        showSize.width = (kCount - 1)*kSpaceSize.width +  kCount * menuSize.width;
//        
//    }
//    else
//    {
//        showSize.width = (kColumn - 1)*kSpaceSize.width +  kColumn * menuSize.width;
//    }
//    
//    showSize.height = (kRow - 1)*kSpaceSize.height +  kRow * menuSize.height;
//    
//    CGRect showRect = CGRectInset(gridRect, (gridRect.size.width - showSize.width)/2, (gridRect.size.height - showSize.height)/2);
//    
//    
//    
//    CGRect menuCellRect = showRect;
...
//        {
//            int index = i * kColumn + j;
//            NSLog(@"i = %d  j = %d index = %d", i, j, index);
//            if (index >= kCount)
//            {
//                return self;
//            }
...
//            
//            //            NSLog(@"view.title = %@", [view titleForState:UIControlStateNormal]);
//            
//            menuCellRect.origin.x += menuCellRect.size.width + kSpaceSize.width;
//        }
//        
//        menuCellRect.origin.x = showRect.origin.x;
...
//}
//
//- (UIView *)gridViews:(NSArray *)views inColumn:(NSInteger)column rowHeight:(CGFloat)height size:(CGSize)cellSize inRect:(CGRect)rect
//{
//    return self;
//}
//
